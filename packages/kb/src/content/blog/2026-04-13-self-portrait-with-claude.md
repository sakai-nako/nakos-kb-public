---
{"description":"AIエージェントに「自分について書いてもらおう」と思い立ち、Claude Codeに自分の輪郭をスケッチしてもらった。その制作プロセスと、得られた一番大きな気づきについて。","pubDate":"2026-04-13","tags":["self-observation","ai","claude-code"],"title":"ずっと刻んでいた自分のリズムに、やっと気づいた話～AIエージェントと一緒につくった自己観察の記録～"}
---
...
そうして出来上がったドキュメントのタイトルは「self-portrait — sakai-nako の輪郭スケッチ」。1万字以上の、自分についての観察メモです。<!-- check-content: ignore (実在ドキュメントのタイトルをそのまま引用) -->
